...
// Using JSX directly to avoid external dependencies.
...
const LibraryIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2Z"/><polyline points="14 2 14 8 20 8"/><path d="M8 14h6"/><path d="M8 18h6"/></svg>
);
...
export const SIDEBAR_LINKS = [
  ...
  { name: 'Students', path: '/students', icon: <UsersIcon className="w-5 h-5" /> },
  { name: 'Classes', path: '/classes', icon: <LibraryIcon className="w-5 h-5" /> },
  { name: 'Staff', path: '/staff', icon: <BriefcaseIcon className="w-5 h-5" /> },
  { name: 'Attendance', path: '/attendance', icon: <ClipboardCheckIcon className="w-5 h-5" /> },
  { name: 'Exams', path: '/exams', icon: <FileTextIcon className="w-5 h-5" /> },
  { name: 'Fees', path: '/fees', icon: <DollarSignIcon className="w-5 h-5" /> },
  { name: 'Finance', path: '/finance', icon: <WalletIcon className="w-5 h-5" /> },
